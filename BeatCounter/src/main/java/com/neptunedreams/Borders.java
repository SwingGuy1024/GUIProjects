...
public enum Borders
{
	...
	public static void addBorder(JComponent cmp, Border brdr)
	{
		...
		if (curBdr != null) {
			brdr = new CompoundBorder(brdr, curBdr);
		}
		cmp.setBorder(brdr);
	}
	 ...
	 * @param pBrdr The Border
	 * @param pCmp The JComponent
	 */ 
	public static void addBorder(Border pBrdr, JComponent[] pCmp)
	{
